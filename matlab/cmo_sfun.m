...
% Same initialization as ctrl_init: equilibrium at the initial level 24 V,
% iL(0) = 2.4 A, vC(0) = 24 V (set on the L and C blocks by the runner).
p = block.DialogPrm(1).Data;
s = zeros(8, 1);
r0 = 24; vC0 = 24; iL0 = 2.4; vo0 = 24;
d0 = ff(r0, p);
s(5) = d0; s(6) = d0;
switch p(1)
