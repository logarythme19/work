...
| E12 | **Défaut corrigé après campagne : feedforward calculé avec le plant simulé** | Le §1 impose un feedforward nominal figé. Le noyau v6.1 utilisait les paramètres du plant en cours (coins inclus) ; seul l'étage 2 est concerné. Correction : paramètres du feedforward passés à part, toujours nominaux. Impact mesuré (`scripts/impact_feedforward.py`) en réévaluant les 540 candidats retenus : toujours **0 faisable** ; écart médian faible (+0,002 à +0,004), mais **19 cellules bougent de plus de 0,05 et 18 d'entre elles se dégradent**, parfois fortement (v5b IGWO graine 2026092420 : −0,067 → −0,425). Le défaut **favorisait** donc les correcteurs : le résultat négatif est prudent à son égard, mais certaines marges d'étage 2 publiées sont trop optimistes. **Campagne relancée en entier** après correction (protocole v6.2, amendement A5) : étage 1 identique dans les 540 cellules, toujours 0 faisable, meilleures marges −0,4392 → −0,4405 (v5), −0,0667 → −0,0664 (v5b), −0,3123 → −0,3177 (v5kp), classement des méthodes inchangé. Les résultats v6.2 font foi ; ceux de v6.1 sont conservés. | Corrigé et relancé (protocole v6.2). |
