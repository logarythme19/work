...
\begin{itemize}
\item \textbf{Modèle.} Tous les résultats portent sur un simulateur commuté
  écrit en Python, non sur le modèle Simulink de référence. Les snubbers n'y
  figurent pas, la diode suit une loi affine statique, et aucune validation
  croisée avec Simulink n'a été faite.
