...
\item \textbf{Modèle.} La campagne a tourné sur un simulateur commuté écrit
  ...
  $C_s=\infty$).
\item \textbf{Défaut corrigé et campagne relancée.} Le feedforward de
  l'étage~2 utilisait d'abord les paramètres du plant perturbé. La campagne a
  été relancée en entier après correction (protocole v6.2) ; les conclusions
  sont inchangées.
