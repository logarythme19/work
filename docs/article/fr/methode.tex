...
% ---------------------------------------------------------------------------
\section{Système, mission et invariants}
\label{sec:systeme}
...
\section{Synthèse FO-LQI et projection vers FO-PIDF}
...
\section{Audit de saturation des bornes}
\label{sec:audit}
...
\section{Recherche étagée et six métaheuristiques}
\label{sec:recherche}
...
\section{Statistiques prédéclarées}
\label{sec:stats}
