...
\item \textbf{Model.} The campaign ran on a switched simulator written in
  ...
  $C_s=\infty$).
\item \textbf{Defect corrected after the campaign.} The stage-2 feedforward
  used the perturbed plant parameters instead of the frozen nominal values.
  Re-evaluated after correction, the 540 retained candidates remain
  infeasible, but 18 cells degrade by more than $0.05$: the defect favoured
  the controllers, and some stage-2 margins are optimistic. The stage-2
  search has not been rerun.
