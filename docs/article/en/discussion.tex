...
\begin{itemize}
\item \textbf{Model.} All results concern a switched simulator written in
  Python, not the reference Simulink model. Snubbers are absent, the diode
  follows a static affine law, and no cross-validation against Simulink has
  been carried out.
