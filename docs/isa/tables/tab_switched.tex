...
CMO--LQI--SF (twin, measured $i_L$) & 0.0347 & \textbf{0.02} & \textbf{22.87} & \textbf{0.0} & \textbf{0.214} & 97.978 & 0.01800 & 0.008 & 0.99 & 5/5 & $v_o,i_L,i_C$\\
PIDF, direct gain search & 0.0363 & \textbf{0.02} & \textbf{22.42} & \textbf{25.0} & \textbf{0.137} & 97.978 & 0.01801 & 0.089 & 1.00 & 5/5 & $v_o$\\
PIDF7, direct search & 0.0348 & \textbf{0.02} & \textbf{22.11} & \textbf{0.0} & \textbf{0.164} & 97.978 & 0.01800 & 0.011 & 0.96 & 5/5 & $v_o$\\
PID, direct search & 0.0368 & \textbf{0.02} & \textbf{21.83} & \textbf{23.7} & \textbf{0.138} & 97.980 & 0.01798 & 0.087 & 0.95 & 5/5 & $v_o$\\
PI, direct search & 0.0943 & \textbf{0.23} & \textbf{6.04} & \textbf{6.8} & \textbf{0.369} & 97.987 & 0.01786 & 0.009 & 0.74 & 5/5 & $v_o$\\
\midrule
